...
<style>
         body {
            background-image: url('https://images6.alphacoders.com/129/1294592.jpg');
...
<body>
    <div class="col-md-4">
            <div><img src="../imagenes/tenencia.png" style="position: absolute; top: 40px; left: 30px; width: 220px; height: 100px;"></div>
        </div>
    <br><br><br><br><br>
    <div class="container">
        <h1 align="center" style="color:aliceblue">Listado de usuarios</h1>
    </div>
    <br>
    <div class="container">
